...
<a href="<?php echo base_url();?>" class="logo">
	<div style="text-align:center;"><img height="50" src="<?php echo base_url().'assets/theme_admin/img/logo2.jpg'; ?>"></div>
</a>-->
<!-- /.search form -->
...
<ul class="treeview-menu">
	...
	<?php } ?>
	<li class="<?php if ($this->uri->segment(1) == 'data_barang') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>data_barang"> <i class="fa fa-folder-open-o"></i> Data Product </a></li>
